...
o Create an array of few instances of the GSM class.
o Display the information about the GSMs in the array.
o Display the information about the static property IPhone4S.
Problem 8. Calls
...
o Create an instance of the GSM class.
o Add few calls.
o Display the information about the calls.
o Assuming that the price per minute is 0.37 calculate and print the total price of the calls in the history.
o Remove the longest call from the history and calculate the total price again.
o Finally clear the call history and print it.
OOP Homework
